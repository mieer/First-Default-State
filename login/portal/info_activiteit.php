...
<!-- Patient Profile in Tab -->
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" style="margin-left: 0px;" >
        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            <h4 class="panel-title">Activiteit Video</h4>
          </div>
  ...
  <iframe src="https://www.youtube.com/watch?v=8VT_RilWcPo" width="500" height="352" frameborder="0" allowfullscreen></iframe>
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                ...
                <p style="font-weight: bold;">Activiteit</p>
